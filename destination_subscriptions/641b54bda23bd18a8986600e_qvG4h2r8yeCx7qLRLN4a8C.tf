import {
  to = segment_destination_subscription.id-641b54bda23bd18a8986600e_qvG4h2r8yeCx7qLRLN4a8C
  id = "641b54bda23bd18a8986600e:qvG4h2r8yeCx7qLRLN4a8C"
}

resource "segment_destination_subscription" "id-641b54bda23bd18a8986600e_qvG4h2r8yeCx7qLRLN4a8C" {
  action_id      = "9STyJcVfDee2NowS4DGdmW"
  destination_id = "641b54bda23bd18a8986600e"
  enabled        = true
  model_id       = null
  name           = "Identify Calls"
